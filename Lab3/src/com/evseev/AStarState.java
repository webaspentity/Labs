...
public class AStarState
{
    ...
    public Waypoint getMinOpenWaypoint()
    {
        ...
        for (Waypoint wp : openedWaypoints.values()) {
            wpCost = wp.getTotalCost();
            if (wpCost < minCost) {
                minCost = wpCost;
                minOpenWaypoint = wp;
            }
        }
        //System.out.println(minOpenWaypoint.toString());
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        ...
        if (!openedWaypoints.containsKey(loc)) {
            openedWaypoints.put(loc, newWP);
            return true;
        }
        if(newWP.getPreviousCost() < openedWaypoints.get(loc).getPreviousCost()) {
            openedWaypoints.put(loc, newWP);
            return true;
        }
        return false;
    ...
    {
        closedWaypoints.put(loc, openedWaypoints.remove(loc));
    }
